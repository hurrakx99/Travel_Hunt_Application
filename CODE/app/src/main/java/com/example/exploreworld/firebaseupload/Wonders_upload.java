...
public class Wonders_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wonders_upload);
        imgpackage=findViewById(R.id.packageimg);
        upload=findViewById(R.id.upwonderdata);
        scrollView=findViewById(R.id.wonderuploadview);
        back=findViewById(R.id.upwonderback);

        txt_title=findViewById(R.id.upwondertitle);
        txt_location=findViewById(R.id.upwonderlocation);
        txt_day=findViewById(R.id.upwonderday);
        txt_price=findViewById(R.id.upwonderprice);
        txt_description=findViewById(R.id.upwonderdescription);
        txt_tips=findViewById(R.id.upwondertips);
        imagepackage1=findViewById(R.id.upwonderimg1);
        imagepackage2=findViewById(R.id.upwonderimg2);
        imagepackage3=findViewById(R.id.upwonderimg3);
        imagepackage4=findViewById(R.id.upwonderimg4);
        imagepackage5=findViewById(R.id.upwonderimg5);
        imagepackage6=findViewById(R.id.upwonderimg6);
        imagepackage7=findViewById(R.id.upwonderimg7);
        imagepackage8=findViewById(R.id.upwonderimg8);
        imagepackage9=findViewById(R.id.upwonderimg9);
        imagepackage10=findViewById(R.id.upwonderimg10);
        txt_resortrating=findViewById(R.id.wonderresortrating);
        txt_resortrating2=findViewById(R.id.wonderresortrating2);
        txt_activity1=findViewById(R.id.wonderactivitytitle1);
        txt_activity2=findViewById(R.id.wonderactivitytitle2);
        txt_activity3=findViewById(R.id.wonderactivitytitle3);
        txt_activity4=findViewById(R.id.wonderactivitytitle4);
        txt_resorttitle=findViewById(R.id.wonderresorttitle);
        txt_resortlocation=findViewById(R.id.wonderresortlocation);
        txt_resortdescription=findViewById(R.id.wonderresortdetails);
        txt_resortprice=findViewById(R.id.wonderresortprice);
        txt_resorttitle2=findViewById(R.id.wonderresorttitle2);
        txt_resortlocation2=findViewById(R.id.wonderresortlocation2);
        txt_resortdescription2=findViewById(R.id.wonderresortdetails2);
        txt_resortprice2=findViewById(R.id.wonderresortprice2);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty()) {
                    Toast.makeText(Wonders_upload.this, "Please enter title", Toast.LENGTH_SHORT).show();
                } else {
                    storageReference = FirebaseStorage.getInstance().getReference().child("tourpackages").child("wonderpackage").child(title);
                    alertDialog=new SpotsDialog.Builder().setContext(Wonders_upload.this).build();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_REQUEST_CODE10 && resultCode == RESULT_OK && data !=null) {
            ...
            Toast.makeText(Wonders_upload.this, "Please select images", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    else
                    {
                        ...
                        myRef.child("wonderpackage").child(title).setValue(profleMap);
