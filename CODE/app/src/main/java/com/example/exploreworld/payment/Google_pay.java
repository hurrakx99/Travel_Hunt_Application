...
public class Google_pay extends AppCompatActivity  implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollView=findViewById(R.id.gpayview);
        price=findViewById(R.id.amtpay);
        name=findViewById(R.id.gpersonname);
        id=findViewById(R.id.gpayupid);
        msg=findViewById(R.id.gnote);
        btn=findViewById(R.id.gpaynow);
        imageView=findViewById(R.id.gpayback);
    ...
    private void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .create(Google_pay.this)// only if listener is implemented by fragment
                .show();
    }
    public static boolean isAppInstalled(Context context, String GOOGLE_PAY_PACKAGE_NAME)
    {
        try
        {
