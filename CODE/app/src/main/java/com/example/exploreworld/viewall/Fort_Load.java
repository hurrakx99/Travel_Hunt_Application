...
public class Fort_Load extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fort__load);
        recyclerView=findViewById(R.id.recycler_fort);
        ...
        if(null!=infos) {
            progressBar=findViewById(R.id.spin_kitf);
            Wave wave=new Wave();
