...
public class Religious_viewall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_religious_viewall);
        recyclerView=findViewById(R.id.recycler_viewall4);
        ...
        if(null!=infos) {
            progressBar=findViewById(R.id.spin_kitr);
            Wave wave=new Wave();
