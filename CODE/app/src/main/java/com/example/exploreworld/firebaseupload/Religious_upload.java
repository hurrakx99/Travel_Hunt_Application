...
public class Religious_upload extends AppCompatActivity {
    ImageView imgpackage,imagepackage1,imagepackage2,imagepackage3,imagepackage4,imagepackage5,imagepackage6;
    Uri uri,uri1,uri2,uri3,uri4,uri5,uri6;
    Button upload;
    ScrollView scrollView;
    EditText txt_title,txt_location,txt_day,txt_price,txt_description,txt_tips,txt_resorttitle,txt_resortlocation,txt_resortdescription,txt_resortprice,txt_resorttitle2,txt_resortlocation2,txt_resortdescription2,txt_resortprice2,txt_resortrating,txt_resortrating2;
    ...
    private String mUri,mUri1,mUri2,mUri3,mUri4,mUri5,mUri6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_religious_upload);
        imgpackage=findViewById(R.id.packageimg);
        upload=findViewById(R.id.upreligiousdata);
        scrollView=findViewById(R.id.religiousuploadview);
        back=findViewById(R.id.upreligiousback);

        txt_title=findViewById(R.id.upreligioustitle);
        txt_location=findViewById(R.id.upreligiouslocation);
        txt_day=findViewById(R.id.upreligiousday);
        txt_price=findViewById(R.id.upreligiousprice);
        txt_description=findViewById(R.id.upreligiousdescription);
        txt_tips=findViewById(R.id.upreligioustips);
        txt_resortrating=findViewById(R.id.religiousresortrating);
        txt_resortrating2=findViewById(R.id.religiousresortrating2);
        imagepackage1=findViewById(R.id.upreligiousimg1);
        imagepackage2=findViewById(R.id.upreligiousimg2);
        imagepackage3=findViewById(R.id.upreligiousimg3);
        imagepackage4=findViewById(R.id.upreligiousimg4);
        imagepackage5=findViewById(R.id.upreligiousimg5);
        imagepackage6=findViewById(R.id.upreligiousimg6);
        
        txt_resorttitle=findViewById(R.id.religiousresorttitle);
        txt_resortlocation=findViewById(R.id.religiousresortlocation);
        txt_resortdescription=findViewById(R.id.religiousresortdetails);
        txt_resortprice=findViewById(R.id.religiousresortprice);
        txt_resorttitle2=findViewById(R.id.religiousresorttitle2);
        txt_resortlocation2=findViewById(R.id.religiousresortlocation2);
        txt_resortdescription2=findViewById(R.id.religiousresortdetails2);
        txt_resortprice2=findViewById(R.id.religiousresortprice2);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty()) {
                    Toast.makeText(Religious_upload.this, "Please enter title", Toast.LENGTH_SHORT).show();
                } else {
                    storageReference = FirebaseStorage.getInstance().getReference().child("tourpackages").child("religiouspackage").child(title);
                    alertDialog=new SpotsDialog.Builder().setContext(Religious_upload.this).build();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_REQUEST_CODE6 && resultCode == RESULT_OK && data !=null) {
            ...
            Toast.makeText(Religious_upload.this, "Please select images", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    else
                    {
                        ...
                        profleMap.put("resort", mUri5);
                        profleMap.put("semiresort", mUri6);
                        ...
                        myRef.child("religiouspackage").child(title).setValue(profleMap);
