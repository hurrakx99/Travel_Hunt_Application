...
public class International_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_international_upload);
        imgpackage=findViewById(R.id.packageimg);
        upload=findViewById(R.id.upinternationaldata);
        scrollView=findViewById(R.id.internationaluploadview);
        back=findViewById(R.id.upinternationalback);

        txt_title=findViewById(R.id.upinternationaltitle);
        txt_location=findViewById(R.id.upinternationallocation);
        txt_day=findViewById(R.id.upinternationalday);
        txt_price=findViewById(R.id.upinternationalprice);
        txt_description=findViewById(R.id.upinternationaldescription);
        txt_tips=findViewById(R.id.upinternationaltips);
        imagepackage1=findViewById(R.id.upinternationalimg1);
        imagepackage2=findViewById(R.id.upinternationalimg2);
        imagepackage3=findViewById(R.id.upinternationalimg3);
        imagepackage4=findViewById(R.id.upinternationalimg4);
        imagepackage5=findViewById(R.id.upinternationalimg5);
        imagepackage6=findViewById(R.id.upinternationalimg6);
        imagepackage7=findViewById(R.id.upinternationalimg7);
        imagepackage8=findViewById(R.id.upinternationalimg8);
        imagepackage9=findViewById(R.id.upinternationalimg9);
        imagepackage10=findViewById(R.id.upinternationalimg10);

        txt_activity1=findViewById(R.id.internationalactivitytitle1);
        txt_activity2=findViewById(R.id.internationalactivitytitle2);
        txt_activity3=findViewById(R.id.internationalactivitytitle3);
        txt_activity4=findViewById(R.id.internationalactivitytitle4);
        txt_resorttitle=findViewById(R.id.internationalresorttitle);
        txt_resortlocation=findViewById(R.id.internationalresortlocation);
        txt_resortdescription=findViewById(R.id.internationalresortdetails);
        txt_resortprice=findViewById(R.id.internationalresortprice);
        txt_resorttitle2=findViewById(R.id.internationalresorttitle2);
        txt_resortlocation2=findViewById(R.id.internationalresortlocation2);
        txt_resortdescription2=findViewById(R.id.internationalresortdetails2);
        txt_resortprice2=findViewById(R.id.internationalresortprice2);
        txt_resortrating=findViewById(R.id.internationalresortrating);
        txt_resortrating2=findViewById(R.id.internationalresortrating2);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty()) {
                    Toast.makeText(International_upload.this, "Please enter title", Toast.LENGTH_SHORT).show();
                } else {
                    storageReference = FirebaseStorage.getInstance().getReference().child("tourpackages").child("internationalpackage").child(title);
                    alertDialog=new SpotsDialog.Builder().setContext(International_upload.this).build();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_REQUEST_CODE10 && resultCode == RESULT_OK && data !=null) {
            ...
            Toast.makeText(International_upload.this, "Please select images", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    else
                    {
                        ...
                        myRef.child("internationalpackage").child(title).setValue(profleMap);
