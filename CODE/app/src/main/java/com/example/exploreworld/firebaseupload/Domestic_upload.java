...
public class Domestic_upload extends AppCompatActivity {
    ...
    AlertDialog alertDialog;
        ...
        ImageView back;
        private DatabaseReference myRef,myratingref;

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.activity_domestic_upload);
            imgpackage=findViewById(R.id.packageimg);
            upload=findViewById(R.id.updomesticdata);
            scrollView=findViewById(R.id.domesticuploadview);
            back=findViewById(R.id.updomesticback);

            txt_title=findViewById(R.id.updomestictitle);
            txt_location=findViewById(R.id.updomesticlocation);
            txt_day=findViewById(R.id.updomesticday);
            txt_price=findViewById(R.id.updomesticprice);
            txt_description=findViewById(R.id.updomesticdescription);
            txt_tips=findViewById(R.id.updomestictips);
            txt_resortrating=findViewById(R.id.domesticresortrating);
            txt_resortrating2=findViewById(R.id.domesticresortrating2);
            imagepackage1=findViewById(R.id.updomesticimg1);
            imagepackage2=findViewById(R.id.updomesticimg2);
            imagepackage3=findViewById(R.id.updomesticimg3);
            imagepackage4=findViewById(R.id.updomesticimg4);
            imagepackage5=findViewById(R.id.updomesticimg5);
            imagepackage6=findViewById(R.id.updomesticimg6);
            imagepackage7=findViewById(R.id.updomesticimg7);
            imagepackage8=findViewById(R.id.updomesticimg8);
            imagepackage9=findViewById(R.id.updomesticimg9);
            imagepackage10=findViewById(R.id.updomesticimg10);

            txt_activity1=findViewById(R.id.domesticactivitytitle1);
            txt_activity2=findViewById(R.id.domesticactivitytitle2);
            txt_activity3=findViewById(R.id.domesticactivitytitle3);
            txt_activity4=findViewById(R.id.domesticactivitytitle4);
            txt_resorttitle=findViewById(R.id.domesticresorttitle);
            txt_resortlocation=findViewById(R.id.domesticresortlocation);
            txt_resortdescription=findViewById(R.id.domesticresortdetails);
            txt_resortprice=findViewById(R.id.domesticresortprice);
            txt_resorttitle2=findViewById(R.id.domesticresorttitle2);
            txt_resortlocation2=findViewById(R.id.domesticresortlocation2);
            txt_resortdescription2=findViewById(R.id.domesticresortdetails2);
            txt_resortprice2=findViewById(R.id.domesticresortprice2);
            ...
            if(null!=infos) {            back.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            upload.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (title.isEmpty()) {
                        Toast.makeText(Domestic_upload.this, "Please enter title", Toast.LENGTH_SHORT).show();
                    } else {
                        storageReference = FirebaseStorage.getInstance().getReference().child("tourpackages").child("domesticpackage").child(title);
                        alertDialog=new SpotsDialog.Builder().setContext(Domestic_upload.this).build();
                        alertDialog.setMessage("Uploading Packages...");
                        alertDialog.show();
        ...
        protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
            ...
            if(requestCode == GALLERY_REQUEST_CODE10 && resultCode == RESULT_OK && data !=null) {
                ...
                Toast.makeText(Domestic_upload.this, "Please select images", Toast.LENGTH_SHORT).show();
            }
        }
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (title.isEmpty()) {
                            ...
                            Toast.makeText(Domestic_upload.this, "Please enter location", Toast.LENGTH_SHORT).show();
                        } else if (description.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter description", Toast.LENGTH_SHORT).show();
                        } else if (price.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter price", Toast.LENGTH_SHORT).show();
                        } else if (day.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter no. of day/night", Toast.LENGTH_SHORT).show();
                        } else if (activity1.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of 1st activity", Toast.LENGTH_SHORT).show();
                        } else if (activity2.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of 2nd activity", Toast.LENGTH_SHORT).show();
                        } else if (activity3.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of 3rd activity", Toast.LENGTH_SHORT).show();
                        } else if (activity4.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of 4th activity", Toast.LENGTH_SHORT).show();
                        } else if (hotelname.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of resort", Toast.LENGTH_SHORT).show();
                        } else if (hotellocation.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter location of resort", Toast.LENGTH_SHORT).show();
                        } else if (hoteldescription.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter some description about resort", Toast.LENGTH_SHORT).show();
                        } else if (hotelprice.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter price of resort per room", Toast.LENGTH_SHORT).show();
                        } else if (hotelname2.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter title of semi resort", Toast.LENGTH_SHORT).show();
                        } else if (hotellocation2.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter location of semi resort", Toast.LENGTH_SHORT).show();
                        } else if (hoteldescription2.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter some description about semi resort", Toast.LENGTH_SHORT).show();
                        }
                        else if (hotelprice2.isEmpty()) {
                            Toast.makeText(Domestic_upload.this, "Please enter price of semi resort per room", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        {
                            Toast.makeText(Domestic_upload.this, "select package image.", Toast.LENGTH_SHORT).show();
                        }
                        else if(mUri1==null)
                        {
                            Toast.makeText(Domestic_upload.this, "select package image.", Toast.LENGTH_SHORT).show();
                        ...
                        else
                        {
                            ...
                            myRef.child("domesticpackage").child(title).setValue(profleMap);
