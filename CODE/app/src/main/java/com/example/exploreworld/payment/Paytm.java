...
public class Paytm extends AppCompatActivity implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollView = findViewById(R.id.paytmview);
        price = findViewById(R.id.amtpaytm);
        name = findViewById(R.id.paytmpersonname);
        id = findViewById(R.id.paytmupid);
        msg = findViewById(R.id.paytmnote);
        btn = findViewById(R.id.paytmnow);
        imageView = findViewById(R.id.paytmback);
        ...
        id.setText("saiprasadpatil1999@oksbi");
    ...
    private void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .create(Paytm.this)// only if listener is implemented by fragment
                .show();
    }

    public static boolean isAppInstalled(Context context, String PAYTM_PACKAGE_NAME     )
    {
        try
        {
            context.getPackageManager().getApplicationInfo(PAYTM_PACKAGE_NAME     ,0);
            return true;
