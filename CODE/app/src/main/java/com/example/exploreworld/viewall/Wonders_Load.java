...
public class Wonders_Load extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wonders__load);
        recyclerView=findViewById(R.id.recycler_wonder);
        ...
        if(null!=infos) {
            progressBar=findViewById(R.id.spin_kitw);
            Wave wave=new Wave();
