...
public class International_viewall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_international_viewall);
        recyclerView = findViewById(R.id.recycler_viewall2);
        ...
        if(null!=infos) {
            progressBar=findViewById(R.id.spin_kiti);
            Wave wave=new Wave();
