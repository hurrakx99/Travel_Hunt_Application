...
public class Phone_pe extends AppCompatActivity implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price = findViewById(R.id.amtpe);
        name = findViewById(R.id.pepersonname);
        id = findViewById(R.id.peupid);
        msg = findViewById(R.id.penote);
        btn = findViewById(R.id.penow);
        imageView = findViewById(R.id.peback);
    ...
    private void paywithGpay() {
        if(isAppInstalled(this,PHONE_PE_PACKAGE_NAME )) {
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(uri);
            intent.setPackage(PHONE_PE_PACKAGE_NAME );
            startActivityForResult(intent, PHONE_PE_REQUEST_CODE);
        }
        else {
    ...
    private void showRatingDialog() {
        new AppRatingDialog.Builder()
                ...
                .create(Phone_pe.this)// only if listener is implemented by fragment
                .show();
    }
    @Override
    ...
    public static boolean isAppInstalled(Context context, String PHONE_PE_PACKAGE_NAME )
    {
        try
        {
            context.getPackageManager().getApplicationInfo(PHONE_PE_PACKAGE_NAME ,0);
            return true;
