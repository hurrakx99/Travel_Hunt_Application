...
public class Popular_viewall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popular_viewall);
        recyclerView=findViewById(R.id.recycler_viewall3);
        ...
        if(null!=infos) {
            progressBar=findViewById(R.id.spin_kitp);
            Wave wave=new Wave();
