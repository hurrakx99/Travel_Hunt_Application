...
public class Forts_upload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forts_upload);
        imgpackage=findViewById(R.id.packageimg);
        upload=findViewById(R.id.upfortdata);
        scrollView=findViewById(R.id.fortuploadview);
        back=findViewById(R.id.upfortback);

        txt_title=findViewById(R.id.upforttitle);
        txt_location=findViewById(R.id.upfortlocation);
        txt_day=findViewById(R.id.upfortday);
        txt_price=findViewById(R.id.upfortprice);
        txt_description=findViewById(R.id.upfortdescription);
        txt_tips=findViewById(R.id.upforttips);
        imagepackage1=findViewById(R.id.upfortimg1);
        imagepackage2=findViewById(R.id.upfortimg2);
        imagepackage3=findViewById(R.id.upfortimg3);
        imagepackage4=findViewById(R.id.upfortimg4);
        imagepackage5=findViewById(R.id.upfortimg5);
        imagepackage6=findViewById(R.id.upfortimg6);
        imagepackage7=findViewById(R.id.upfortimg7);
        imagepackage8=findViewById(R.id.upfortimg8);
        imagepackage9=findViewById(R.id.upfortimg9);
        imagepackage10=findViewById(R.id.upfortimg10);

        txt_activity1=findViewById(R.id.fortactivitytitle1);
        txt_activity2=findViewById(R.id.fortactivitytitle2);
        txt_activity3=findViewById(R.id.fortactivitytitle3);
        txt_activity4=findViewById(R.id.fortactivitytitle4);
        txt_resorttitle=findViewById(R.id.fortresorttitle);
        txt_resortlocation=findViewById(R.id.fortresortlocation);
        txt_resortdescription=findViewById(R.id.fortresortdetails);
        txt_resortprice=findViewById(R.id.fortresortprice);
        txt_resorttitle2=findViewById(R.id.fortresorttitle2);
        txt_resortrating=findViewById(R.id.fortresortrating);
        txt_resortrating2=findViewById(R.id.fortresortrating2);
        txt_resortlocation2=findViewById(R.id.fortresortlocation2);
        txt_resortdescription2=findViewById(R.id.fortresortdetails2);
        txt_resortprice2=findViewById(R.id.fortresortprice2);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty()) {
                    Toast.makeText(Forts_upload.this, "Please enter title", Toast.LENGTH_SHORT).show();
                } else {
                    storageReference = FirebaseStorage.getInstance().getReference().child("tourpackages").child("fortpackage").child(title);
                    alertDialog=new SpotsDialog.Builder().setContext(Forts_upload.this).build();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == GALLERY_REQUEST_CODE10 && resultCode == RESULT_OK && data !=null) {
            ...
            Toast.makeText(Forts_upload.this, "Please select images", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    else
                    {
                        ...
                        myRef.child("fortpackage").child(title).setValue(profleMap);
